...
//       {isOpen && (
//         <div className="md:hidden bg-white/90 backdrop-blur-lg border-t border-gray-200 px-6 py-6 space-y-4 text-xs font-semibold uppercase tracking-wider text-altiusNavy">
