...
//   return (
//     <div id="programs-sidebar" className="lg:col-span-4 bg-white p-4 border border-gray-200 shadow-sm space-y-1.5 sticky top-28" style={{ borderRadius: '8px' }}>
//       <h3 className="font-serif font-bold text-xs uppercase tracking-wider text-altiusNavy px-3 py-2 border-b border-gray-100 mb-2 flex items-center gap-2">
