...
export default function TcfTefContent() {
  return (
    <div className="space-y-6">
      <div className="bg-white p-6 sm:p-8 border border-gray-200 space-y-4" style={{ borderRadius: '8px' }}>
        <h3 className="font-serif font-bold text-xl text-altiusNavy">Examination Focus Tracks</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {["TCF Examination Practice", "TEF Examination Practice", "French language skill development", "Speaking practice", "Listening practice", "Reading practice", "Writing practice"].map((item, idx) => (
